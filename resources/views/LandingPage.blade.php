...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>SBP | Laravel 10 Breeze CRUD</title>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('tmp_landingpage/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('tmp_landingpage/assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('tmp_landingpage/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('tmp_landingpage/assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ asset('tmp_landingpage/assets/img/favicons/mstile-150x150.png') }}">
    ...
    <link href="{{ asset('tmp_landingpage/vendors/prism/prism.css') }}" rel="stylesheet">
    <link href="{{ asset('tmp_landingpage/vendors/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
    <link href="{{ asset('tmp_landingpage/assets/css/theme.css') }}" rel="stylesheet" />
    <link href="{{ asset('tmp_landingpage/assets/css/user.css') }}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="{{ asset('') }}tmp_landingpage/assets/img/Logo.png" alt="" /></a>
      ...
      <div class="bg-dark"><img class="img-fluid position-absolute end-0" src="{{ asset('') }}tmp_landingpage/assets/img/hero/hero-bg.png" alt="" />
        ...
        <section>
          ...
          <div class="container">
            <div class="row align-items-center py-lg-8 py-6">
              ...
              <div class="col-lg-6 text-center text-lg-end mt-3 mt-lg-0"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/hero/hero-graphics.png" alt="" /></div>
            </div>
            <div class="swiper">
              <div class="swiper-container swiper-shadow swiper-theme" data-swiper='{"slidesPerView":2,"breakpoints":{"640":{"slidesPerView":2,"spaceBetween":20},"768":{"slidesPerView":4,"spaceBetween":40},"992":{"slidesPerView":5,"spaceBetween":40},"1024":{"slidesPerView":4,"spaceBetween":50},"1025":{"slidesPerView":6,"spaceBetween":50}},"spaceBetween":10,"grabCursor":true,"pagination":{"el":".swiper-pagination","clickable":true},"loop":true,"freeMode":true,"autoplay":{"delay":2500,"disableOnInteraction":false}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="{{ asset('') }}tmp_landingpage/assets/img/logos/presto.png" alt="" /></div>
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row gx-xl-7 mt-5">
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('') }}tmp_landingpage/assets/img/services/1.png" alt="" />
            ...
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('') }}tmp_landingpage/assets/img/services/2.png" alt="" />
              <h4 class="mt-3 my-1">Even cooler feature</h4>
              <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
            </div>
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('') }}tmp_landingpage/assets/img/services/3.png" alt="" />
              <h4 class="mt-3 my-1">Cool feature title</h4>
              <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
            </div>
          </div>
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/offer/1.png" alt="" /></div>
            <div class="col-lg-6">
      ...
      <section class="pt-8 pt-lg-0">
        ...
        <div class="container">
          <div class="d-flex flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/offer/2.png" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="{{ asset('') }}tmp_landingpage/assets/img/review/1.png" alt="" />
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="{{ asset('') }}tmp_landingpage/assets/img/review/2.png" alt="" />
                      <div class="text-black">
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="{{ asset('') }}tmp_landingpage/assets/img/review/3.png" alt="" />
                      <div class="text-black">
      ...
      <section>
        ...
        <div class="container"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/offer/3.png" alt="" />
        ...
        <div class="container">
          ...
          <div class="row mt-7 gx-xl-7">
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('') }}tmp_landingpage/assets/img/blog/1.png" alt="" /></a>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/blog/profile1.png" alt="" /><a href="#">
                    <p class="mb-0 text-gray">Chandler Bing</p>
                  </a></div>
              </div>
            </div>
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('') }}tmp_landingpage/assets/img/blog/2.png" alt="" /></a>
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                    <p class="fw-bold mb-0 text-black">Category</p>
                  </a>
                  <p class="mb-0">November 22, 2021</p>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/blog/profile2.png" alt="" /><a href="#">
                    <p class="mb-0 text-gray">Rachel Green</p>
                  </a></div>
              </div>
            </div>
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('') }}tmp_landingpage/assets/img/blog/3.png" alt="" /></a>
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                    <p class="fw-bold mb-0 text-black">Category</p>
                  </a>
                  <p class="mb-0">November 22, 2021</p>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('') }}tmp_landingpage/assets/img/blog/profile3.png" alt="" /><a href="#">
    ...
    <section>
      ...
      <div class="container bg-dark overflow-hidden rounded-1">
        <div class="bg-holder" style="background-image:url({{ asset('') }}tmp_landingpage/assets/img/promo/promo-bg.png);">
        </div>
        <!--/.bg-holder-->
    ...
    <section class="pt-0">
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6 col-sm-12"><a href="index.html"><img class="img-fluid mt-5 mb-4" src="{{ asset('') }}tmp_landingpage/assets/img/black-logo.png" alt="" /></a>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('tmp_landingpage/vendors/popper/popper.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/anchorjs/anchor.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/is/is.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/lodash/lodash.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('tmp_landingpage/vendors/prism/prism.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/vendors/swiper/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('tmp_landingpage/assets/js/theme.js') }}"></script>
